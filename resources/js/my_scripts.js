...
function loadPlayersPage()
{
	...
	for(playerIndex in players)
	{
		...
		player.setAttribute("onclick", "switchPlayers" + playerIndex);
		player.innerHTML = players[playerIndex].name;

		selector.appendChild(player);
		tags = tags + "<a class=\"dropdown-item\" onclick=\"switchPlayers(" + playerIndex + ")\">" + players[playerIndex].name + "</a>";
	}
...
function switchPlayers(playerNum)
{
	...
	document.getElementById("player_image").innerHTML = player.img;
